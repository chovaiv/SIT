...
class LogUserForm(Form):
    ...
    jmeno = TextField('Choose your username', validators=[
        ...
        Length(min=2, max=30, message="Please use between 3 and 30 characters"),
    ...
    pohlavi = SelectField('Pohlavi', choices=[('Muz'), ('Zena'), ('text', 'Plain Text')])
...
class formKformular(Form):
    a = FloatField("Strana a:",validators=[NumberRange(min=0, message="Hodnota vetsi ZERO") ,InputRequired(message="vyzadovano")])
    b = FloatField("Strana b:",validators=[NumberRange(min=0, message="Hodnota vetsi ZERO"), InputRequired(message="vyzadovano")])
